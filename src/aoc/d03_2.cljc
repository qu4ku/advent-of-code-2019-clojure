; day03-2: https://adventofcode.com/2019/day/3
...
(def a (get-points [0 0] (first data) []))
(def b (get-points [0 0] (second data) []))
...
(defn ans-2 [data]
  (let [int (apply vector (intersection data))
        a (get-points [0 0] (first data) [])
        b (get-points [0 0] (second data) [])]
    (+ 2 (apply min (map get-sum int)))))
